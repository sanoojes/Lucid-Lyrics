...
export type NotificationItem = Required<NotificationData>;

export const pendingQueue: NotificationData[] = [];

export let addNotification: ((item: NotificationData) => void) | null = null;
...
const NotificationManager: FC = () => {
  ...
  const processNotification = ({ id, message, isError, timeout }: NotificationData) => {
  ...
  return (
    <div className="lyrics-notification-container">
