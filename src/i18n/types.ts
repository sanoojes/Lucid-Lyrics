export type Dict = {
  ...
  "backup.title": string;
  "backup.copyConfig": string;
  "backup.copyFailed": string;
  "backup.copySuccess": string;
  "backup.exportConfig": string;
  "backup.exportConfigDesc": string;
  "backup.exportPath": string;
  "backup.exportSuccess": string;
  "backup.importConfig": string;
  "backup.importConfigDesc": string;
  "backup.importEditDesc": string;
  "backup.importEditPlaceholder": string;
  "backup.importFailed": string;
  "backup.importFailedDesc": string;
  "backup.importOpenFile": string;
